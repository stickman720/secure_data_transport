...
<h3>used widget:</h3>
<p>I'm using Golang and gin for base .</p>
<p>For connction to database i use sqlc . first I use SQLite database then I migrate to MySQL or PostgreSQL .</p>
<p>You can see the architecture in arch.txt file</p>
